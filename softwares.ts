...
export async function installBottom() {
	...
	await run(`wget https://github.com/ClementTsang/bottom/releases/download/0.14.9/bottom_0.14.9-1_amd64.deb -O ./bottom_amd64.deb`.split(' '))
...
export async function installLazygit() {
	...
	await run(`wget https://github.com/jesseduffield/lazygit/releases/download/v0.65.1/lazygit_0.65.1_linux_32-bit.tar.gz -O lazygit.tar.gz`.split(' '))
